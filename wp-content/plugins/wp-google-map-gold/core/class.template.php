...
if ( ! class_exists( 'FlipperCode_HTML_Markup' ) ) {
	...
	class FlipperCode_HTML_Markup {
		 ...
		 * @var Array
		 */
		private $form_elements = array( 'extensions','text','checkbox','multiple_checkbox','radio','submit','button','select', 'hidden', 'wp_editor', 'html', 'datalist','textarea' , 'file' , 'div' , 'blockquote','html' , 'image','group','table', 'message', 'anchor', 'image_picker', 'radio_slider' );
		/**
		 * Attributes Allowed
		 * @var Array
		 */
		...
		*/
		...
		public function __construct( ) {
			...
			$this->allowed_attributes = array_fill_keys( array( 'min', 'max', 'choose_button', 'remove_button', 'lable', 'id', 'class', 'required', 'default_value', 'value', 'options', 'desc', 'before', 'after', 'radio-val-label', 'onclick', 'placeholder', 'textarea_rows', 'textarea_name', 'html', 'current', 'width', 'height', 'src', 'alt', 'heading', 'data', 'show', 'optgroup' ) , '' );
		...
		public function get_manage_url() {
			return "<a style='float:right' target='_blank' href='http://codecanyon.net/downloads'>Rate Me - <img src='".WPGMP_IMAGES."rating.png' /></a>";
		}
		/**
