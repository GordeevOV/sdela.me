<div class="w2dc-content">
	<div class="w2dc-directory-frontpanel">
		...
		<a class="w2dc-favourites-link w2dc-btn w2dc-btn-primary" href="<?php echo w2dc_directoryUrl(array('w2dc_action' => 'myfavourites')); ?>"><span class="w2dc-glyphicon w2dc-glyphicon-star"></span> <?php _e('My bookmarks', 'W2DC'); ?></a>
		<?php endif; ?>
	
		<?php if (isset($listing)): ?>
			<?php if (w2dc_show_edit_button($listing->post->ID)): ?>
			<a class="w2dc-edit-listing-link w2dc-btn w2dc-btn-primary" href="<?php echo w2dc_get_edit_listing_link($listing->post->ID); ?>"><span class="w2dc-glyphicon w2dc-glyphicon-pencil"></span> <?php _e('Edit listing', 'W2DC'); ?></a>
			<?php endif; ?>
			...
			<a href="javascript:void(0);" class="w2dc-pdf-listing-link w2dc-btn w2dc-btn-primary" onClick="window.open('http://pdfmyurl.com/?url=<?php echo urlencode(add_query_arg('w2dc_action', 'pdflisting', get_permalink($listing->post->ID))); ?>');"><span class="w2dc-glyphicon w2dc-glyphicon-save"></span> <?php _e('Save listing in PDF', 'W2DC'); ?></a>
			<?php endif; ?>
		<?php endif; ?>
	</div>
</div>