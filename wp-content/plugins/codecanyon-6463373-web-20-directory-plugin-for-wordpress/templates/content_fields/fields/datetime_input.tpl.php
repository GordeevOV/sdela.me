<script>
	(function($) {
		...
		$(function() {
			...
			<?php endif; ?>
			$("#reset_date_<?php echo $content_field->id; ?>").click(function() {
	...
	<div class="w2dc-col-md-10">
		<div class="w2dc-row w2dc-form-group w2dc-clearfix">
			...
			<div class="w2dc-col-md-3">
				<input type="button" class="w2dc-btn w2dc-btn-primary" id="reset_date_<?php echo $content_field->id; ?>" value="<?php esc_attr_e('reset date', 'W2DC')?>" />
			</div>
		</div>
