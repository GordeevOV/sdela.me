...
<div class="w2dc-content">
	<div class="w2dc-submit-section-adv">
		<?php if ($packages): ?>
				...
				<div class="w2dc-col-sm-<?php echo $cols_width; ?> w2dc-plan-column" style="width: <?php echo $cols_width_percents; ?>%; max-width: 800px;">
					<div class="w2dc-panel w2dc-panel-default w2dc-text-center w2dc-choose-plan">
						<div class="w2dc-panel-heading">
							...
							<?php if ($package->post->post_content): ?><a class="w2dc-hint-icon" href="javascript:void(0);" data-content="<?php echo esc_attr(nl2br($package->post->post_content)); ?>" data-html="true" rel="popover" data-placement="bottom" data-trigger="hover"></a><?php endif; ?>
						</div>
			...
			<?php endforeach; ?>
		<?php else: ?>
			<p><?php _e("There aren't any listings packagess", "W2DC"); ?></p>
		<?php endif; ?>
	</div>
